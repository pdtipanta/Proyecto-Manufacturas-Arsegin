...
public class Dialogo_Buscar_Cliente extends javax.swing.JDialog {
    ...
    public Dialogo_Buscar_Cliente(java.awt.Frame parent, boolean modal) {
        ...
        this.tabla_Clientes.getTableHeader().setFont( new Font( "Arial", Font.BOLD, 13 ) );
        this.tabla_Clientes.getTableHeader().setBackground( new Color( 32, 136, 203 ));
        this.tabla_Clientes.getTableHeader().setForeground( new Color( 255, 255, 255)); 
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(1150, 466));
        setMinimumSize(new java.awt.Dimension(1150, 466));
        setResizable(false);
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 80, 1070, 310));
        ...
        getContentPane().add(campo_Buscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(94, 30, 304, 22));
        ...
        getContentPane().add(combo_Opciones, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 30, 170, 23));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Imagen-fondo-aurora-celeste_1.png"))); // NOI18N
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1150, 466));
