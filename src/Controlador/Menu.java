...
import Controlador.Clientes.Controlador_Cliente;
...
public class Menu implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == this.submenu_Cliente) {
            ...
            Controlador_Cliente controlador_Cliente = new Controlador_Cliente(vista, conexion_Database, this.usuario, this.rol);
