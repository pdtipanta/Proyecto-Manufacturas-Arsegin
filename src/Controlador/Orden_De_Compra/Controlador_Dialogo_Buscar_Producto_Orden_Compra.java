...
public class Controlador_Dialogo_Buscar_Producto_Orden_Compra implements ActionListener, KeyListener, MouseListener{
    ...
    public Controlador_Dialogo_Buscar_Producto_Orden_Compra(Vista_Principal vista, Connection conexion, Panel_Orden_Compra panel_Orden_Compra) {
        this.vista = vista;
    ...
    public Object[] iniciar() {
        ...
        this.dialogo_Buscar_Inventario.barra.setVisible(true);
    ...
    public void keyTyped(KeyEvent ke) {
        ...
        if (this.dialogo_Buscar_Inventario.grupo_Botones.getSelection() == null) {
    ...
    public boolean validar_Existencia_Productos_Tabla() {
        ...
        for (int i = 0; i < this.panel_Orden_Compra.tabla_Productos_Orden_Compra.getRowCount(); i++) {
            if (inventario.get(0).getCodigo().equals(this.panel_Orden_Compra.tabla_Productos_Orden_Compra.getValueAt(i, 1))) {
                bandera = false;
            }
        }
        return bandera;
    ...
    public boolean validar_Existencia_Nuevos_Productos_Tabla(Object[] fila) {
        boolean bandera = true;
        for (int i = 0; i < this.panel_Orden_Compra.tabla_Productos_Orden_Compra.getRowCount(); i++) {
            if (fila[1].equals(this.panel_Orden_Compra.tabla_Productos_Orden_Compra.getValueAt(i, 1))) {
                bandera = false;
            }
        }
        return bandera;
